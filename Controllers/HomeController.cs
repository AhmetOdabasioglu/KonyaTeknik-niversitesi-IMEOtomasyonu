...
namespace IMEAutomationDBOperations.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult aboutme()
        {
            ...
            var (supervisor, company, internshipDetail) = _databaseService.GetSupervisorCompanyAndInternshipDetailsByStudentEmail(email);
        ...
        public IActionResult StudentPage()
        {
            ...
            ViewBag.Email = email;
            ViewBag.UserName = userName ?? "Misafir";
        ...
        public IActionResult GenerateIMEBasvuruFormu()
        {
            ...
            var (supervisor, company, internshipDetail) = _databaseService.GetSupervisorCompanyAndInternshipDetailsByStudentEmail(emailStudent);
        ...
        private Student GetStudentByEmailAndPassword(string email, string password)
        {
            ...
            var students = _databaseService.GetStudentsData();
            return students.FirstOrDefault(s => s.Email == email && s.Password == hashedPassword);
        }
    }
}
